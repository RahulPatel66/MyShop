  ...
  <div class="row mt-5">
   	 <%
      		...
      		Class.forName("com.mysql.jdbc.Driver");
   			...
   			String qr = "select * from cloths where id=?";
    ...
    <div class="col-sm-5 m-auto" style="align-item:center;height:40rem;">
      <img class="card-img-top" src="./clothImage/<%=photo %>" alt="Card image cap">
    </div>
    <div class="col-sm-6" style="height:40rem;">
      <div class="card" style="height:90%">
     
  		<div class="card-title ml-2 mt-3 " style="font-size:1.5rem;"><%=name %> <%=type %></div>
 	 <div class="card-body">
